            ...
            <div class="side-modal-body">
              <div class="side-modal-body-content">
                <div class="panel-condition">
                  ...
                  <ConditionGroup v-for="(item, index) in properties.conditions[0]" :key="index" :data.sync="item" :pos="index" @del="delGroup(index)" />
                  <ConditionAddBtn @click="addCondition" />
                  <div style="float: left;">
                    <el-button type="info" size="small" @click="cancel">
                      <span>取 消</span>
                    </el-button>
                    <el-button type="button" class="ant-btn ant-btn-primary" @click="save">
                      <span>保 存</span>
                    </el-button>
                  </div>
                </div>
